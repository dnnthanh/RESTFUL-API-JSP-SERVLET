            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="table-responsive">
                        <a style="margin-bottom: 8px;" class="btn btn-success" title="Thêm bài viết"
                           href="${pageContext.request.contextPath}/admin/articles?type=edit">
    ...
    function loadRowNew(item) {
        return `\<tr>
							...
							<td>
								...
								<a title="Cập nhật bài viết" href="${pageContext.request.contextPath}/admin/articles?type=edit&id=\${item.id}" class="btn btn-warning">
